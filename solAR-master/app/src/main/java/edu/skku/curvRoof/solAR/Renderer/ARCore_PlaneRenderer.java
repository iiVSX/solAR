...
public class ARCore_PlaneRenderer {
  private static final String TAG = ARCore_PlaneRenderer.class.getSimpleName();

  // Shader names.
  private static final String VERTEX_SHADER_NAME = "ARCore_plane.vert";
  private static final String FRAGMENT_SHADER_NAME = "ARCore_plane.frag";
